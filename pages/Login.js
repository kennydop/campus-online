...
function Login() {
    ...
    <div className="w-screen h-screen flex flex-col justify-center items-center">
      <div className = "flex h85p self-center">
        ...
        <p className="self-center mb-6 text-sm text-gray-500">Don't have an account? <a href="#" className = "text-pink-500 hover:font-bold">Create one</a></p>
