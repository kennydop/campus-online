...
import {getSession, session, signIn, signOut, useSession} from "next-auth/client";
...
function Signup() {
    ...
    function registerWithProvider(provider){
        signIn(provider, {callbackUrl: 'http://localhost:3000/AddCollege'})    
    }
    ...
    <div className="w-screen flex justify-center items-center bg-blue-grey-50 dark:bg-bdark-200">
        ...
        <div className = "flex h-screen self-center w-screen lg:w-2/5 items-center justify-center bg-white dark:bg-bdark-100 lg:bg-transparent">
            <form autoComplete='on' className="authForm">
                ...
                <button className="infobutton prevent-default" type = "button" onClick={registerWithEmail}>Sign Up</button>
