...
function ButtomNavbar() {
    ...
    return (
        ...
        <div>
            ...
            <div className = "flex items-center justify-center absolute space-evenly inset-x-0 z-50 bottom-0 py-3 md:hidden bg-white dark:bg-bdark-100 shadow-mdt">
                ...
                <div className='mx-auto' onClick = {()=>{setPrevTab(tabActive); setTabActive('/'); setTabActive('global')}}><HeaderIcon active = {tabActive === 'global'?true:undefined} Icon = {GlobeAltIcon}/></div>
