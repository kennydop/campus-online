      ...
      <div className='p-2 rounded-lg shadow-md bg-white dark:bg-bdark-100 flex flex-grow flex-col'>
        <div className='py-1 text-center flex space-x-4 border-b border-gray-200 dark:border-bdark-200'>
          ...
          <div className='flex flex-col'>
            <div className='h-3 w-32 md:w-36 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
            <div className='h-2 w-20 md:w-24 mt-1 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
          </div>
        </div>
        {type === 'image' ? 
          <>
            <div className='h-4 w-full my-4 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
            <div className='w-full h-96 bg-gray-200 dark:bg-bdark-50 animate-pulse'></div>
          </>
            :
          <>
            <div className='h-4 w-11/12 mt-4 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
            <div className='h-4 w-10/12 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
            <div className='h-4 w-5/12 mb-4 bg-gray-200 dark:bg-bdark-50 animate-pulse self-start'></div>
