...
function Profile() {
    ...
    return (
        <div className='h-screen w-screen pt-10 flex justify-center z-50'>
            <div className='w-screen md:w-3/5'>
                <div className='relative w-full bg-white rounded-t-lg h-40'>
                    ...
                    <div className='absolute right-0 bottom-0 py-2 px-4 bg-gray-500 bg-opacity-70 cursor-pointer'><CameraIcon className='h-6 text-white'/></div>
                </div>
                ...
                {/* <div className='mt-8 self-center'>
                    <img className = "h-20 w-20 object-cover rounded-full cursor-pointer text-center" src = {session.user.image}/>
                </div>
                <div>
                    <p className = 'text-center  text-xl font-bold'>{session.user.name}</p>
                    <p className = 'text-center  text-xs font-light'>{session.user.email}</p>
                </div>
